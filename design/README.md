...
| [02-main-ide-layout.md](02-main-ide-layout.md)                 | Full IDE grid, file tree, editor, diff viewer, chat, HITL dialog, slash commands, activity strip, HITL chat action blocks | 5, 6    |
